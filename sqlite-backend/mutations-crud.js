// Schema additions for CRUD mutations - to be merged into schema.js

// Add after OrderInput:
const UPDATE_INPUT = `
...
export { UPDATE_INPUT, MUTATIONS_TO_ADD, MUTATION_RESOLVERS };
