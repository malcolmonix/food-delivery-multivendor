...
export default function OriginalStoresPage() {
  ...
  return (
    <main className="p-6 space-y-4">
      <header className="flex items-end justify-between">
        <div>
          <h1 className="text-2xl font-semibold">Stores (Original GraphQL)</h1>
          <p className="text-sm opacity-70 mt-1">Search and manage stores via GraphQL API.</p>
        </div>
        ...
        <div className="overflow-x-auto rounded border border-white/10">
          <table className="w-full text-sm">
            ...
            <tbody>
              ...
              {filtered.length === 0 && (
                <tr><td colSpan={3} className="p-4 opacity-70">No stores</td></tr>
              )}
            </tbody>
          </table>
        </div>
