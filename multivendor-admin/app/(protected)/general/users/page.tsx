...
const UsersPage = () => {
  const [users] = useState([
    { id: 1, name: 'Alice Johnson', email: 'alice@example.com', status: 'Active', orders: 12 },
    { id: 2, name: 'Charlie Brown', email: 'charlie@example.com', status: 'Active', orders: 8 },
    { id: 3, name: 'Diana Prince', email: 'diana@example.com', status: 'Inactive', orders: 3 },
  ]);
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-600 mt-2">
              Manage customer accounts and their orders
            </p>
          </div>
