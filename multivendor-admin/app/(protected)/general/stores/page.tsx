...
const StoresPage = () => {
  const [stores] = useState([
    { id: 1, name: 'Pizza Palace', vendor: 'John Doe', status: 'Active', orders: 45 },
    { id: 2, name: 'Burger King', vendor: 'Jane Smith', status: 'Active', orders: 32 },
    { id: 3, name: 'Sushi World', vendor: 'Bob Johnson', status: 'Inactive', orders: 18 },
  ]);
    ...
    <div className="p-6">
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-600 mt-2">
              Manage store accounts and their operations
            </p>
          </div>
      ...
      <div className="bg-white rounded-lg shadow">
        <div className="p-6 border-b border-gray-200">
          <div className="flex justify-between items-center">
            <h3 className="text-lg font-semibold text-gray-900">Store List</h3>
