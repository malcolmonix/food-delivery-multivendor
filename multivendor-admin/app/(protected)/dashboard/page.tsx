...
import { STAT_CARD_ICON_COLORS } from '@/lib/utils/constants';
    ...
    <div className="p-6">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">
          Welcome to the Multivendor Admin Dashboard
        </p>
      </div>
              ...
              {[1, 2, 3, 4, 5].map((item) => (
                <div key={item} className="flex items-center justify-between py-2">
                  ...
                  <div className="text-right">
                    <p className="text-sm font-medium text-gray-900">$25.99</p>
        ...
        <div className="bg-white rounded-lg shadow">
          ...
          <div className="p-6">
            <div className="grid grid-cols-2 gap-4">
              <button className="p-4 border border-gray-200 rounded-lg hover:bg-primary-color/10 transition-colors">
                <div className="text-center">
                  <div className="w-8 h-8 bg-primary-color/20 rounded-full flex items-center justify-center mx-auto mb-2">
                    <svg className="w-4 h-4 text-primary-color" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
                    </svg>
                  </div>
                  <p className="text-sm font-medium text-gray-900">Add Store</p>
                </div>
              </button>
