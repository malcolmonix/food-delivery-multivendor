...
export default function OriginalMenuItemsPage() {
  ...
  return (
    <main className="p-6 space-y-4">
      <header className="flex items-end justify-between">
        <div>
          <h1 className="text-2xl font-semibold">Menu Items (Original GraphQL)</h1>
          <p className="text-sm opacity-70 mt-1">Browse and search menu items via GraphQL API.</p>
        </div>
